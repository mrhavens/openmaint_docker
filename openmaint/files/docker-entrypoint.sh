...
cat /dev/null > $CATALINA_HOME/conf/openmaint/database.conf
echo "Edit $CATALINA_HOME/conf/openmaint/database.conf"
{
...
} >> $CATALINA_HOME/conf/openmaint/database.conf
...
{ # try
    ...
    $CATALINA_HOME/webapps/openmaint/openmaint.sh dbconfig create $OPENMAINT_DUMP -configfile $CATALINA_HOME/conf/openmaint/database.conf
